!function() {
	...
	var Wa,
		...
		Qa,
		nc,
		tc = ea[p(ea, "requestAnimationFrame")] || function(n) {
				setTimeout(n, 17)
			};
		...
		return n ? t(n) : (t.links = function(n) {
				...
				return iu(e(n)).cells.forEach(function(e, r) {
					for (var u, i, o = e.site, a = e.edges.sort(Yr), c = -1, s = a.length, l = a[s - 1].edge, f = l.l === o ? l.r : l.l; ++c < s;)
						u = l, i = f, l = a[c].edge, f = l.l === o ? l.r : l.l, r < i.i && r < f.i && au(o, i, f) < 0 && t.push([n[r], n[i.i], n[f.i]])
				}), t
			}, t.x = function(n) {
